...
func resourcesConfigYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/config.yml", size: 881, mode: os.FileMode(420), modTime: time.Unix(1460619475, 0)}
